...
Router-IDs (RID) \nomenclature{RID}{Router ID} and ways of detecting duplicate RIDs. 
...
\nomenclature{DVCS}{Distributed Version Control System} Firstly, version
...
\bibitem{draft-dimitri-zospf-00}
...
\bibitem{draft-ietf-ospf-ospfv3-autoconfig-00}
	OSPFv3 Auto-Configuration \\
	A. Lindem, J. Arkko\\
	\url{http://tools.ietf.org/html/draft-ietf-ospf-ospfv3-autoconfig-00}

\bibitem{draft-arkko-homenet-prefix-assignment-03}
