...
\begin{itemize}
    \item OSPF: Anatomy of an Internet Routing Protocol
    \item OSPF: Complete Implementation
    \item OSPF and IS-IS
\end{itemize}
...
GitHub is really good. And I am pretty sure they put a lot of effort into backup.
