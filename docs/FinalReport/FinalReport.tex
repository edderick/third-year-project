...
finding media streaming severs and printers on a home network. At present, a
device must reside on the same subnet as a service to be able to discover it as
the service discovery messages are not forwarded by the router. 
...
accessible from another. Uses for this include: monitoring home appliances from
