...
router belongs to. Appendix~\ref{LSA-HEADEER} shows the structure of
an LSA header. 
...
Below is a list of Open source implementations of OSPF. There are also
...
\subsection{Quagga}
Quagga\cite{QuaggaHome} is a more heavyweight package, it is a fork of a now
defunct GNU project called Zebra. Quagga is written in C, and aims to be
...
came up with the following MoSCoW style Specification.
